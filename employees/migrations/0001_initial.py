    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_degree', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.academicdegree')),
                ('academic_rank', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.academicrank')),
